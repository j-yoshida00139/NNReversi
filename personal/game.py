    ...
    def goNextTurn(self):
        ...
        if self.canPutPieceOnBoard(self.nextColor):
            ...
            if self.canPutPieceOnBoard(self.nextColor):
                ...
                winnersData = self.getWinnersData()
#                print(winnersData)
#                self.sendWinnersData(winnersData)
                return False
    ...
    def returnNnInputList(self, rawArray, color):
        arrangeList = []
    ...
    def storeWinnersData(self, winnersData):
        ...
        for i in range(len(winnersData)):
            ...
            inputList = self.returnNnInputList(winnersMove["arrange"], winnersMove["color"])
            fileNo = lastFileNo + i
            ...
            dataWriterIn.writerow(self.returnNnInputStoreList(inputList))
            fIn.close()
    ...
    def getLastFileNo(self):
        path = os.path.dirname(os.path.abspath(__file__)) + "/nncore/winnersData/"
        fileNoList = [self.retrieveFileNo(f) for f in listdir(path) if isfile(join(path, f))]
    ...
    def returnNnInputStoreList(self, rawArray):
        arrangeList = []
    ...
    def retrieveFileNo(self, filename):
        print(filename)
